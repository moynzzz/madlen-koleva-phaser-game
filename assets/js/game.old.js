...
preload.prototype = {
    preload: function () {
        ...
        // load title screen
        game.load.image('title', 'sprites/title-screen.png');
        game.load.image('enter', 'sprites/press-enter-text.png');
        game.load.image('credits', 'sprites/credits-text.png');
        game.load.image('instructions', 'sprites/instructions.png');
        // environment
        game.load.image('background', 'environment/back.png');
        game.load.image('middleground', 'environment/middle.png');
        //tileset
        game.load.image('tileset', 'environment/tileset.png');
        game.load.tilemap('map', 'maps/map.json', null, Phaser.Tilemap.TILED_JSON);
        // atlas sprites
        game.load.atlasJSONArray('atlas', 'atlas/atlas.png', 'atlas/atlas.json');
        game.load.atlasJSONArray('atlas-props', 'atlas/atlas-props.png', 'atlas/atlas-props.json');
		//
		game.load.audio('music', ['sound/platformer_level03_loop.ogg']);
    },
    create: function () {
